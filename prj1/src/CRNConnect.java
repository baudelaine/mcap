...
public class CRNConnect {
	...
	public ContentManagerService_PortType connectToCognosServer() {
		...
		while (bibus == null) {
			...
			try {
				...
				lg("Service Exception:\n" + e.getMessage());
				e.printStackTrace();
				return null;
			}

			try {
				cmService.query(new SearchPathMultipleObject("/"), new PropEnum[] {}, new Sort[] {},
						new QueryOptions());
				...
				lg(" CRNConnect " + nullEx.getMessage());
				return null;
			}

			// Retrieve the biBusHeader SOAP:Header that contains
			// the logon information.
			SOAPHeaderElement x = ((Stub) cmService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/",
					"biBusHeader");
	...
	public AgentService_PortType getAgentService(boolean isNewConversation, String RSGroup) {
		...
		bibus = BIBusHeaderHelper.getHeaderObject(
				((Stub) agentService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"),
				isNewConversation, RSGroup);

		if (bibus == null) {
			BiBusHeader CMbibus = null;
			CMbibus = BIBusHeaderHelper.getHeaderObject(
					((Stub) cmService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"),
					true, RSGroup);
	...
	public BatchReportService_PortType getBatchRepService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) batchRepService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
	...
	public DataIntegrationService_PortType getDataIntService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) dataIntService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
	...
	public DeliveryService_PortType getDeliveryService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) deliveryService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
	...
	public DimensionManagementService_PortType getDimensionManagementService(boolean isNewConversation,
			String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) dimensionMgmtService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
		...
		if (bibus == null) {
			...
			((Stub) dimensionMgmtService).setHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader",
					CMbibus);
		} else {
			((Stub) dimensionMgmtService).clearHeaders();
			((Stub) dimensionMgmtService).setHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader",
	...
	public EventManagementService_PortType getEventMgmtService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) eventMgmtService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
	...
	public JobService_PortType getJobService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(
				((Stub) jobService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"),
				isNewConversation, RSGroup);
	...
	public MetadataService_PortType getMetadataService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) metadataService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
	...
	public MonitorService_PortType getMonitorService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) monitorService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
	...
	public ReportService_PortType getReportService(boolean isNewConversation, String RSGroup) {
		...
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(
				((Stub) repService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"),
				isNewConversation, RSGroup);
	...
	public QueryService_PortType getQueryService(boolean isNewConversation, String RSGroup) {
		...
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(
				((Stub) queryService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"),
				isNewConversation, RSGroup);
	...
	public SystemService_PortType getSystemService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(
				((Stub) sysService).getResponseHeader("http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"),
				isNewConversation, RSGroup);
	...
	public Dispatcher_PortType getDispatcherService(boolean isNewConversation, String RSGroup) {
		BiBusHeader bibus = null;
		bibus = BIBusHeaderHelper.getHeaderObject(((Stub) dispatchService).getResponseHeader(
				"http://developer.cognos.com/schemas/bibus/3/", "biBusHeader"), isNewConversation, RSGroup);
